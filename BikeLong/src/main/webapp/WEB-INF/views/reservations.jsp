...
<html lang="en">
	...
	<body>
		...
		<div class="wrapper">
			...
			<!-- Hero-->
			<section class="module-cover parallax" data-background="resources/assets/images/module-6.jpg" data-overlay="1" data-gradient="1">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 m-auto text-center">
							<p class="subtitle">Make a reservation</p>
