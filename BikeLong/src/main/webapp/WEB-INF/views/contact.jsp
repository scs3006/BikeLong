...
<html lang="en">
	<head>
		...
		<!-- Favicons-->
		<link rel="shortcut icon" href="resources/resources/assets/images/favicon.png">
		<link rel="apple-touch-icon" href="resources/resources/assets/images/apple-touch-icon.png">
		<link rel="apple-touch-icon" sizes="72x72" href="resources/resources/assets/images/apple-touch-icon-72x72.png">
		<link rel="apple-touch-icon" sizes="114x114" href="resources/resources/assets/images/apple-touch-icon-114x114.png">
		<!-- Web Fonts-->
		<link href="https://fonts.googleapis.com/css?family=PT+Serif%7cSignika:300,400,600,700" rel="stylesheet">
		<!-- Bootstrap core CSS-->
		<link href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/css/bootstrap.min.css" rel="stylesheet">
		<!-- Plugins and Icon Fonts-->
		<link href="resources/resources/assets/css/plugins.min.css" rel="stylesheet">
		<!-- Template core CSS-->
		<link href="resources/resources/assets/css/template.css" rel="stylesheet">
	</head>
	<body>
		...
		<header class="header">
			...
			<div class="navigation navigation-center">
				<div class="container-fluid">
					<!-- Brand-->
					<div class="inner-header"><a class="inner-brand" href="index.jsp"><img class="brand-dark" src="resources/resources/assets/images/logo.png" width="74px" alt=""><img class="brand-light" src="resources/resources/assets/images/logo-light.png" width="74px" alt=""></a></div>
					<!-- Navigation-->
		...
		<div class="wrapper">
			...
			<section class="maps-container">
				<div class="map" data-addresses="[48.859822, 2.352647]" data-info="[Lorem ipsum dolor sit amet.]" data-icon="resources/resources/assets/images/map-icon.png" data-zoom="15"></div>
			</section>
			<!-- Map end-->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-6 m-auto text-center">
							...
							<h1 class="display-1">Send a Message</h1>
								...
								<div class="row">
									...
									<div class="col-md-12">
										...
										<div class="text-center">
											<input class="btn btn-black" type="submit" value="Send Message">
										</div>
									</div>
								</div>
							</form>
					...
					<div class="row">
						<div class="col-md-3">
							...
							<aside class="widget widget_text">
								<div class="textwidget">
									<p><img src="resources/resources/assets/images/logo-light.png" width="74px" alt=""></p>
						...
						<div class="col-md-3">
							...
							<aside class="widget widget_recent_works">
								...
								<ul>
									<li><a href="#"><img src="resources/resources/assets/images/widgets/1.jpg" alt=""></a></li>
									<li><a href="#"><img src="resources/resources/assets/images/widgets/2.jpg" alt=""></a></li>
									<li><a href="#"><img src="resources/resources/assets/images/widgets/3.jpg" alt=""></a></li>
									<li><a href="#"><img src="resources/resources/assets/images/widgets/4.jpg" alt=""></a></li>
									<li><a href="#"><img src="resources/resources/assets/images/widgets/5.jpg" alt=""></a></li>
									<li><a href="#"><img src="resources/resources/assets/images/widgets/6.jpg" alt=""></a></li>
								</ul>
							</aside>
						</div>
					</div>
		...
		<!-- Off canvas-->
		<div class="off-canvas-sidebar" data-background="resources/resources/assets/images/sidebar.jpg">
			<div class="off-canvas-sidebar-wrapper">
				...
				<div class="off-canvas-content">
					...
					.textwidget
						.up-logo
							p.text-center.m-b-50: img(src="resources/resources/assets/images/logo-light.png" width="100" alt="")
						.up-form
							form(method="post")
								.form-group
			...
			<div class="container">
				<div class="row">
					<div class="col-md-4 p-0">
						<div class="qwert" data-background="resources/resources/assets/images/module-2.jpg"></div>
					</div>
					<div class="col-md-8">
		...
		<script src="resources/resources/assets/js/plugins.min.js"></script>
