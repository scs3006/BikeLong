	...
	<section class="module-page-title">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6">
					<h1 class="page-title-heading">건의사항 - 글 수정</h1>
				</div>
				<div class="col-md-6">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active">
							<a href="/bikelong/suggestions/detail.action?boardNo=${board.boardNo}&pageno=${pageno}">Suggestions Detail</a>
						</li>
						<li class="breadcrumb-item active">Suggestions Update</li>
					</ol>
				</div>
			</div>
		</div>
