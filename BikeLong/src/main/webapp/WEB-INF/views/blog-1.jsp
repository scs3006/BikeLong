				...
				<div class="container">
					<div class="row blog-masonry">
						...
						<div class="col-md-4 post-item">
							...
							<!-- Post-->
							<article class="post">
								<div class="post-preview"><a href="#"><img src="resources/assets/images/menu/7.jpg" alt=""></a></div>
								<div class="post-wrapper">
									<div class="post-header">
						...
						<div class="col-md-4 post-item">
							...
							<!-- Post-->
							<article class="post">
								<div class="post-preview"><a href="#"><img src="resources/assets/images/menu/3.jpg" alt=""></a></div>
								<div class="post-wrapper">
									<div class="post-header">
						...
						<div class="col-md-4 post-item">
							...
							<!-- Post-->
							<article class="post">
								<div class="post-preview"><a href="#"><img src="resources/assets/images/menu/8.jpg" alt=""></a></div>
								<div class="post-wrapper">
									<div class="post-header">
										<h2 class="post-title display-1"><a href="blog-single-1.jsp">Which Lamb is the Best: American, Australian or New Zealand?</a></h2>
									</div>
						...
						<div class="col-md-4 post-item">
							...
							<!-- Post-->
							<article class="post">
								<div class="post-preview"><a href="#"><img src="resources/assets/images/menu/9.jpg" alt=""></a></div>
								<div class="post-wrapper">
									<div class="post-header">
										<h2 class="post-title display-1"><a href="blog-single-1.jsp">The Caipirinha Is The Brazilian Cocktail You’ve Been Too Afraid To Pronounce</a></h2>
									</div>
