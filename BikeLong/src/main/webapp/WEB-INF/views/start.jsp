...
<html lang="en">
	...
	<body>
		...
		<div class="wrapper">
			...
			<!-- Hero-->
			<section class="module-cover parallax" data-background="resources/assets/images/module-8.jpg" data-overlay="1" data-gradient="1">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<div class="text-center"><img src="resources/assets/images/logo-light.png" alt="">
								<div class="space" data-mY="20px"></div>
								<p>Tavern is a elegant, luxury and trendy bootstrap 4 restaurant template. <br> It is a very simple, clean and minimalist theme.</p>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="module">
				<div class="container">
					<div class="row">
						<div class="col-md-6 m-auto text-center">
							...
							<h1 class="display-1">Hero Demos</h1>
				...
				<div class="container-fluid custom-container">
					<div class="row">
						<div class="col-md-4">
							<div class="demo-preview"><a href="index.jsp"><img src="resources/assets/images/demo/1.jpg" alt="">
									<h6>01. Parallax</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-2.jsp"><img src="resources/assets/images/demo/2.jpg" alt="">
									<h6>02. Slider</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-3.jsp"><img src="resources/assets/images/demo/3.jpg" alt="">
									<h6>03. Text Slider</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-4.jsp"><img src="resources/assets/images/demo/4.jpg" alt="">
									<h6>04. Youtube</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-5.jsp"><img src="resources/assets/images/demo/5.jpg" alt="">
									<h6>05. Vimeo</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-6.jsp"><img src="resources/assets/images/demo/6.jpg" alt="">
									<h6>06. Local Video</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-12.jsp"><img src="resources/assets/images/demo/12.jpg" alt="">
									<h6>07. Video & Sound</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-13.jsp"><img src="resources/assets/images/demo/13.jpg" alt="">
									<h6>08. Small Hero</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-14.jsp"><img src="resources/assets/images/demo/14.jpg" alt="">
									<h6>09. Without Hero</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-17.jsp"><img src="resources/assets/images/demo/17.jpg" alt="">
									<h6>10. Snow</h6></a>
			...
			<section class="module divider-top">
				<div class="container">
					<div class="row">
						<div class="col-md-6 m-auto text-center">
							<p class="subtitle">Discover</p>
							<h1 class="display-1">Header Options</h1>
							<p class="lead">See how your users experience your website in realtime or view <br/> trends to see any changes in performance over time.</p>
							<div class="divider-border"></div>
						</div>
					</div>
				...
				<div class="container-fluid custom-container">
					<div class="row">
						<div class="col-md-4">
							<div class="demo-preview"><a href="index.jsp"><img src="resources/assets/images/demo/1.jpg" alt="">
									<h6>01. Header Full width</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-7.jsp"><img src="resources/assets/images/demo/7.jpg" alt="">
									<h6>02. Header Boxed</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-8.jsp"><img src="resources/assets/images/demo/8.jpg" alt="">
									<h6>03. Without Topbar</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-9.jsp"><img src="resources/assets/images/demo/9.jpg" alt="">
									<h6>04. White header</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-10.jsp"><img src="resources/assets/images/demo/10.jpg" alt="">
									<h6>05. White header without topbar</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-11.jsp"><img src="resources/assets/images/demo/11.jpg" alt="">
									<h6>06. White and boxed</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-15.jsp"><img src="resources/assets/images/demo/15.jpg" alt="">
									<h6>07. Navigation right</h6></a></div>
						</div>
						<div class="col-md-4">
							<div class="demo-preview"><a href="index-16.jsp"><img src="resources/assets/images/demo/16.jpg" alt="">
									<h6>07. Navigation right - boxed</h6></a></div>
						</div>
					</div>
					<div class="row">
						<div class="col-md-12">
