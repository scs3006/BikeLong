...
$(function() {
    ...
    $("#savebtn").click(function(event){
    	...
    	$.ajax({
			url : "/bikelong/trailpathboard/update.action",
			method : "POST",
			data : queryString,
			...
			<div class="row align-items-center">
				...
				<div class="col-md-6">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item active"><a
							href="/bikelong/trailpathboard/detail.action?boardNo=${trailBoardupdate.boardNo}&pageno=${pageno}">
							Trail Detail</a></li>
									...
									<form action="/bikelong/trailpathboard/update.action" id="frm"
										...
										<table class="table table-bordered" >
											<tr>
												<td>제목</td>
												<td colspan="6">
												<input type="text" name="title" value="${trailBoardupdate.title}"
												 style="width: 100%;"></td>
											</tr>
											<tr>
												<td>작성자</td>
												...
												<td><input type="date" name="date"
													value="${trailBoardupdate.date}"></td>
											</tr>
											<tr>
												<td>해당지역</td>
												...
												<td><input type="hidden" name="defaultLocationNo"
													value="${trailBoardupdate.locationNo}"
										...
										<div class="col-md-12">
											<div class="form-group">
												<textarea rows="10" cols="100" name="content" id="content"
													class="form-control" style="width: 200%; height: 500px"
													placeholder="변경할 내용을 입력해주세요" required>${trailBoardupdate.content}</textarea>
											</div>
										</div>
										<div class="col-md-12">
